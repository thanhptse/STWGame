class GameScene extends Phaser.Scene {
    ...
    createGameManager() {
        this.events.on('spawnPlayer', (playerObject) => {
            this.createPlayers(playerObject);
            this.addCollisions();
        });
    ...
    createAudios() {
        ...
        this.monsterDeathSound = this.sound.add('enemyDeath', {
            loop: false,
            volumne: 0.2
        });
    ...
    addCollisions() {
        this.physics.add.collider(this.player, this.map.blockedLayer); // collider between player and block tile layer
